...
import '../scss/style.scss'; // Ensure your SCSS file is imported
                ...
                <Grow in={isVisible} timeout={1000}>
                    <div className='col d-flex justify-content-center align-items-center mx-0'>
                        <div className='text-center custom-font rounded bg-white p-3 shadow'>
                            ...
                            <h3 className=''>
                                "People will suffer from mental<br /> disorder, according to the<br />
                                <u className='custom-blue-font'>World Health Organization (WHO)</u>"
                            </h3>
                        </div>
                    </div>
                </Grow>
            </VisibilitySensor>
            <div className='col d-flex justify-content-center mx-0 pie-chart-container'>
                <VisibilitySensor onChange={onVisibilityChange}>
